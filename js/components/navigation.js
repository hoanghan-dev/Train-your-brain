 ...
 * Tự động render Header, Sidebar, Mobile Bottom Nav và đồng bộ trạng thái
 */
...
(function () {
    ...
    function renderGlobalNavbar() {
        ...
        if (isLoginPage) return; // Màn đăng nhập không cần thanh điều hướng
            ...
            headerPlaceholder.innerHTML = `
                <header class="app-topbar d-flex align-items-center justify-content-between px-3 py-2 border-bottom border-secondary border-opacity-25 sticky-top bg-dark-panel">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <span class="badge bg-primary-subtle text-cyan border border-info border-opacity-25 small-tag d-none d-md-inline-block">LIVE PREVIEW</span>
                    </div>
            ...
            sidebarPlaceholder.innerHTML = `
                <aside class="desktop-sidebar d-none d-md-flex flex-column justify-content-between p-3 border-end border-secondary border-opacity-25 bg-dark-panel">
                    <div>
                        ...
                        <div class="sidebar-action-card p-3 rounded-3 border border-primary border-opacity-25 text-white mb-3">
                    ...
                    <div class="border-top border-secondary border-opacity-25 pt-3">
                        <div class="d-flex align-items-center justify-content-between px-2">
                            <span class="text-xxs text-white-50">BrainArena Preview</span>
        ...
        // Gắn sự kiện reset data trên sidebar
